...
HEADER_TRASLATIONS_DICT = {
    ...
    KEY_HEADERS["imp_comp"]: ["mont. comp.", "mont. tot.", "Costo totale", "imp.comp.c."],
}
...
TYPES_MAP = {KEY_HEADERS["costo_unit"]: float,
...
SHEET_COL_SEQ_FASE = [KEY_HEADERS["fase"],]+ SHEET_COL_SEQ
